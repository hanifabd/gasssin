...
<head>
    ...
    <!-- bootstrap js -->
    <title><?php echo $row['nama_mahasiswa'] ?> | Gasssin</title>
            ...
            <div class="w-100">
                <div class="w-100 fadeindown mb-20">
                    <div class="mt-48">
                        <center>
                            <div>
                                <span class="rounded-circle mr-2"><img class="img_image_profile_user rounded-circle" src="<?php echo "upload/profile_pict/".$row['file_pp']; ?>" alt=""></span>
                            </div>
                            <div class="mt-12">
                                <span class="fcwhitesmoke fs36 etnic-san"><?php echo $row['nama_mahasiswa']; ?></span>
                            </div>
                            <div class="prof-desc mt-12">
                                <span class="fclbrown"><?php echo $row['biografi_mahasiswa'] ?></span>
                            </div>
                        </center>
                    </div>
                </div>
                ...
                <div class="w-100 mt-24">
                    ...
                    <?php
                        ...
                        if (isset($_POST['cari'])) {
                            ...
                            $query2 = "SELECT * FROM project WHERE id_mahasiswa=$id AND judul LIKE '%$kata_cari%' OR deskripsi LIKE '%$kata_cari%' ORDER BY tgl_upload DESC";
                        } else {
